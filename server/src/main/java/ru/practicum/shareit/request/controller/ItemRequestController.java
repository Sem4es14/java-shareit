...
public class ItemRequestController {
    ...
    @PostMapping
    public ResponseEntity<ItemRequestResponse> create(@RequestBody ItemRequestCreate requestCreate,
    ...
    @GetMapping("/all")
    public ResponseEntity<List<ItemRequestResponse>> getAll(@RequestParam(defaultValue = "0") Long from,
    ...
    public ResponseEntity<ItemRequestResponse> getById(@PathVariable Long requestId,
