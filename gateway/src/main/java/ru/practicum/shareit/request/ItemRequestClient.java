...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> createRequest(ItemRequestCreate requestCreate, Long requesterId) {
        return post("", requesterId, requestCreate);
    }
    ...
    public ResponseEntity<Object> getAll(Long requesterId, Long from, Integer size) {
